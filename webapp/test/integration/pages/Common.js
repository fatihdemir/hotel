sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/havelsan/HOTEL/app", ".html");
		...
		return Opa5.extend("com.havelsan.HOTEL.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/havelsan/HOTEL/localService/mockserver"], function (mockserver) {
